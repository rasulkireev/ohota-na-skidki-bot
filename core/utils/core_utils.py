...
def get_ohota_na_skidki_bot_logger(name):
    """This will add a `ohota_na_skidki_bot` prefix to logger for easy configuration."""

    return structlog.get_logger(f"ohota_na_skidki_bot.{name}")
